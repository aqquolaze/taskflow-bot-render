...
// Меню AI инструментов (с разделением на доступные и будущие)
const aiToolsMenu = {
    inline_keyboard: [
        [
...
// Меню "Без ИИ" (механики и сервисы)
const noAiToolsMenu = {
    inline_keyboard: [
        [
...
// Меню "Скоро" (тизеры будущих функций)
...
Многофункциональная платформа для заработка и продвижения.

🤖 *AI Инструменты* — генерация контента, резюме, репетитор
⚙️ *Без ИИ* — быстрые услуги, обменник токенов
🔥 *Скоро* — новые функции каждый месяц
...
📅 *Подпишись на анонсы в нашем канале!*
...
🔗 *Ссылка на профиль:* ${SITE_URL}/profile`);
            break;
...
💎 *Пополни баланс:* ${SITE_URL}/buy
📋 *Заработай:* Выполняй задания

🎁 *Бонус:* Приведи друга → +50 токенов

👉 *Активные способы заработка:*
• Быстрые услуги
• Создание заданий
...
📋 *Биржа заданий* — заработок и продвижение

🔗 *Сайт:* ${SITE_URL}
📧 *Поддержка:* @aquozales

❓ *FAQ:*
• Как заработать? → Выполняй задания
• Как вывести? → P2P обменник (скоро)
• Какие AI инструменты? → Генератор постов и идей
